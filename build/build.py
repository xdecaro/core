...
for required in (
    LIB_SRC / "xdecarocore.xml",
    COMPONENT_SRC / "xdecarocore.xml",
    PLUGIN_SRC / "xdecarocore.xml",
    PACKAGE_MANIFEST,
    PACKAGE_SCRIPT,
):
    if not required.is_file():
        raise SystemExit(f"Missing Core build input: {required}")
...
artifacts = [library_zip, component_zip, plugin_zip, package_zip]
